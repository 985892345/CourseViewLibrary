...
interface IFoldImpl {
     ...
     */
    fun foldNoonForce(onChanged: ((weight: Float, fraction: Float) -> Unit)? = null)
     ...
     */
    fun unfoldNoonForce(onChanged: ((weight: Float, fraction: Float) -> Unit)? = null)
     ...
     */
    fun foldDuskForce(onChanged: ((weight: Float, fraction: Float) -> Unit)? = null)
     ...
     * 带有动画的强制展开中午时间段。会 cancel 掉之前的动画
     */
    fun unfoldDuskForce(onChanged: ((weight: Float, fraction: Float) -> Unit)? = null)
