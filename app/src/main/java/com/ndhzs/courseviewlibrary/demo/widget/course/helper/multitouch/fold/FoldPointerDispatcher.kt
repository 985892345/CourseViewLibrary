package com.ndhzs.courseviewlibrary.demo.widget.course.helper.multitouch.fold
...
import com.ndhzs.courseviewlibrary.demo.widget.course.helper.multitouch.CourseRecyclerPointerDispatcher
import com.ndhzs.courseviewlibrary.demo.widget.course.helper.multitouch.entitymove.EntityMovePointerDispatcher
        ...
        when (event.action) {
            DOWN -> {
                ...
                if (x in timeLineLeft..timeLineRight) { // 如果 x 落在左侧时间轴上
                    ...
                    if (!hasEntityMoveInNoon) { // 没得的话才能点击产生效果
                        // 中午那一行的显示范围
                    ...
                    if (!hasEntityMoveInDusk) { // 没得的话才能点击产生效果
                        // 傍晚那一行的显示范围
