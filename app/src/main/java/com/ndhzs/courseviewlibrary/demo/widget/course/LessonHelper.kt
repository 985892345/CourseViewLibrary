...
//            .from(context)
//            .inflate(R.layout.lib_item_lesson, course, false) as LessonView
...
//        if (lp.startRow <= NOON_TOP && lp.endRow >= NOON_BOTTOM) {
//            if (course.getNoonRowState() == RowState.FOLD) {
//                course.unfoldNoonWithoutAnim()
//            }
//        }
//        if (lp.startRow <= DUSK_TOP && lp.endRow >= DUSK_BOTTOM) {
